...
final class NewsViewController: UIViewController {
  ...
  lazy var searchController: UISearchController = {
    ...
    searchController.searchBar.placeholder = Constants.SystemWords.searchNews
...
extension NewsViewController: UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    guard let cell = tableView.dequeueReusableCell(withIdentifier: Constants.NewsTable.newsCellID, for: indexPath) as? NewsCell else { return UITableViewCell() }
...
extension NewsViewController: NewsCellDelegate {
  func didTapFavoriteButton(cell: UITableViewCell) {
    ...
    delegate?.viewDidTapFavoriteButton(
